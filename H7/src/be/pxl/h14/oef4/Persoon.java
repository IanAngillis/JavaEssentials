...
public class Persoon {
	...
	//Constructor
	Persoon(String newNaam, String newVoornaam, int newDag, int newMaand, int newJaar, String newStraat, String newHuisnummer, String newPostcode, String newGemeenteNaam) throws DatumException{
